        ...
        <div class="col-6 col-lg-3">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h4 class="text-dark mb-0 mt-3">{{ $products }} Menu</h4>
        ...
        <div class="col-6 col-lg-3">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h4 class="text-dark mb-0 mt-3">Rp. {{ number_format($income) }}</h4>
        ...
        <div class="col-6 col-lg-3">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h4 class="text-dark mb-0 mt-3">{{ number_format($transaction) }} Order</h4>
        ...
        <div class="col-6 col-lg-3">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h4 class="text-dark mb-0 mt-3">{{ $cashiers }} Kasir</h4>
