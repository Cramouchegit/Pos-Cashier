    ...
    <nav class="navbar navbar-expand-lg bg-white py-3">
        <div class="container-fluid">
            <a href="." class="navbar-brand logo">
                <img src="{{ url('assets/images/logo.png') }}" alt=""> Kasir Online Mabuchi
            </a>
    ...
    <footer class="pt-5 pb-4">
        <div class="container">
            <p class="mb-0 text-center text-secondary fs-7">
                Copyright &copy; Guntur Alamsyah Putra at Telkom University 2024. Seluruh hak cipta dilindungi.
            </p>
        </div>
    </footer>
